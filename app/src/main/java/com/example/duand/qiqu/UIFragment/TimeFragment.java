...
import com.example.duand.qiqu.Activity.MapNaviActivity;
...
//        textView.setText(s);
        ...
        begin_navi.setOnClickListener(new View.OnClickListener() {  //跳转至导航页面
            ...
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), MapNaviActivity.class));
            }
        });
        begin_track.setOnClickListener(new View.OnClickListener() {    //开始定位追踪
            ...
            public void onClick(View view) {
                ...
                initAMapTrackClient();   //初始化AMapTrackClient实例
                getTerminal();
            }
        });
